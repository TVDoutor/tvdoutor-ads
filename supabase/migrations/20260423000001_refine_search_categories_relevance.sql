-- Refina busca de categorias para reduzir resultados "poluídos"
-- e priorizar correspondências estritamente relacionadas ao termo buscado.
...
AS $$
  ...
  matched_auto_rows AS (
    ...
    WHERE csn.specialty_norm IS NULL
      ...
      -- Evita strings poluídas (listas inteiras de especialidades em um único campo)
      AND (
