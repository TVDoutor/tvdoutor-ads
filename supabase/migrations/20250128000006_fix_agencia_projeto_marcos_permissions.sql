...
-- 1. Remover todas as políticas existentes da tabela agencia_projeto_marcos
...
-- 5. Criar políticas permissivas para agencia_projeto_marcos
...
DROP TRIGGER IF EXISTS set_agencia_projeto_marcos_created_by_trigger ON public.agencia_projeto_marcos;
CREATE TRIGGER set_agencia_projeto_marcos_created_by_trigger
    BEFORE INSERT OR UPDATE ON public.agencia_projeto_marcos
    FOR EACH ROW
