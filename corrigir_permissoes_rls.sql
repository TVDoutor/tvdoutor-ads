-- Script para corrigir permissões RLS e resolver erros 403
-- Execute este script no Supabase SQL Editor

-- 1. Verificar se a função ensure_profile existe
SELECT routine_name, routine_type 
FROM information_schema.routines 
WHERE routine_schema = 'public' 
  AND routine_name = 'ensure_profile';

-- 2. Criar ou recriar a função ensure_profile se não existir
