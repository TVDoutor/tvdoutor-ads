...
- Inventario de telas e farmacias (cadastro, import/export Excel, geolocalizacao).
- Profissionais da saude (corpo clinico) e vinculos com venues.
...
- RF-32: Gerenciar farmacias (CRUD, import/export Excel, geolocalizacao).
  - CA-17b: Farmacias listadas em `/farmacias` com filtros e exportacao.

### Profissionais da saude
- RF-52: Cadastrar profissionais da saude e vincular a venues.
  - CA-22b: Profissionais listados em `/profissionais-saude`; vinculos refletem em detalhes.
