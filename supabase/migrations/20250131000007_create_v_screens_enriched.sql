-- ===============================
-- CREATE VIEW v_screens_enriched
-- Date: 2025-01-31
-- View enriquecida para o frontend com todos os dados necessários
-- ===============================
...
-- Criar a view v_screens_enriched
...
-- Comentário da view
COMMENT ON VIEW public.v_screens_enriched IS 'View enriquecida com todos os dados necessários para o frontend, incluindo especialidades, classes e rede';
