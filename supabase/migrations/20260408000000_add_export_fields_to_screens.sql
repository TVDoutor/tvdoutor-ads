-- Campos solicitados para exportação comercial de proposta.
ALTER TABLE public.screens
  ADD COLUMN IF NOT EXISTS restricoes text,
  ADD COLUMN IF NOT EXISTS programatica text;

-- Expor os novos campos na view de consulta enriquecida.
