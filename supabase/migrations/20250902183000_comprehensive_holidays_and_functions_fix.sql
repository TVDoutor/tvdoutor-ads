...
-- resolve_effective_cpm: Atualizar para SECURITY DEFINER
...
-- recalc_proposal_kpis: Atualizar para SECURITY DEFINER
...
COMMENT ON FUNCTION public.resolve_effective_cpm(bigint) IS 
'Resolve o CPM efetivo de uma proposta baseado no modo (manual/blended). SECURITY DEFINER para uso em triggers.';

COMMENT ON FUNCTION public.recalc_proposal_kpis(bigint) IS 
'Recalcula todos os KPIs de uma proposta (dias, impactos, valores). SECURITY DEFINER para uso em triggers.';
